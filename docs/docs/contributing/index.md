...
I-Stem team members will be assigned to review your pull requests. Once the
pull requests are approved and pass continuous integration checks, a I-Stem
...
navigate to the
[Github "issues" tab](https://github.com/I-Stem/backend/issues) and start
looking through interesting issues with "Contribution Help".
