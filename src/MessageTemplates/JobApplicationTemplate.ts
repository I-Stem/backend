...
class JobApplicationTemplate {
    public static getJobApplicationMessage(
        props: JobApplicationMessageTemplateProps
    ): MessageModel {
    ...
    public static getJobApplicationReceiptMessage(
        props: JobApplicationMessageTemplateProps
    ): MessageModel {
        return new MessageModel({
            isInternal: false,
...
<p>Team I-Stem</p>
    ...
    public static contactCandidateMessage(
        props: JobApplicationMessageTemplateProps
    ): MessageModel {
        return new MessageModel({
            isInternal: false,
            ...
            label: MessageLabel.JOB_APPLICATION,
            templateId: JobApplicationTemplateNames.CONTACT_CANDIDATE,
            body: props.message || "",
        });
    }
}
